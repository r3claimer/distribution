...
PKG_NAME="citron-sa"
PKG_LICENSE="GPLv2"
PKG_VERSION="0cdd5461521c34719e4777cfc6efc102592758b2"
PKG_SITE="https://git.citron-emu.org/Citron/Citron"
PKG_URL="${PKG_SITE}.git"
PKG_DEPENDS_HOST="toolchain llvm:host"
PKG_DEPENDS_TARGET="toolchain SDL2 boost libevdev libdrm ffmpeg zlib libpng lzo libusb zstd ecm openal-soft pulseaudio alsa-lib qt6 libfmt vulkan-loader vulkan-headers llvm"
...
pre_configure_target() {
  export CFLAGS="${CFLAGS} -Wno-unused-variable -Wno-shadow"
  export CXXFLAGS="${CXXFLAGS} -Wno-unused-variable -Wno-shadow"
}
